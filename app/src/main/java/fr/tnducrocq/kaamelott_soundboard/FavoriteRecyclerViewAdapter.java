...
public class FavoriteRecyclerViewAdapter extends SectionedRecyclerViewAdapter<FavoriteRecyclerViewAdapter.MainVH> {
    ...
    Context context;
    FavoriteRecyclerViewAdapterListener listener;

    public FavoriteRecyclerViewAdapter(FavoriteRecyclerViewAdapterListener listener) {
        super();
        this.listener = listener;
    }

    public interface FavoriteRecyclerViewAdapterListener {
    ...
    public static class SoundViewHolder extends MainVH {
        ...
        public SoundViewHolder(View itemView, FavoriteRecyclerViewAdapterListener listener) {
            super(itemView);
            ButterKnife.bind(this, itemView);
